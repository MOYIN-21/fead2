...
export const Footer = () => {
  return (
    <footer className="sticky bottom-0 bg-blue-300 z-50">
        <div className="w-full max-w-screen-xl mx-auto md:py-20">
            ...
            <span className="block text-sm text-blue-900 sm:text-center">© 2024 <Link href="#" className="text-white hover:underline">Willfead</Link>. All Rights Reserved.</span>
        </div>
    </footer>
