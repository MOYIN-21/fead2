        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className={`w-full md:block md:w-auto ${isMenuOpen ? 'block' : 'hidden'}`} id="navbar-dropdown">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
              ...
              <li>
                <NavLink to="/contact" onClick={closeMenu} className="block py-2 px-3 md:p-0 ">Locate/Contact
                  Us</NavLink>
              </li>
              ...
              <li className="block lg:hidden">
                <NavLink to="/faqs" onClick={closeMenu} className="block py-2 px-3 md:p-0">Faqs</NavLink>
              </li>
            </ul>
          </div>
        </div>
